...
namespace Cross.Web.Controllers
{
    ...
    {
        private readonly CancellationDbEntityManager<Event> _eventManager;
        private readonly DbEntityManager<RaceType>_raceTypeManager;
        private readonly DbEntityManager<Venue>_venueManager;

        public EventsController(CancellationDbEntityManager<Event> eventManager, DbEntityManager<RaceType> raceTypeManager, DbEntityManager<Venue> venueManager)
        {
