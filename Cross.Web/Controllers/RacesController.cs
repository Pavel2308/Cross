...
namespace Cross.Web.Controllers
{
    public class RacesController : Controller
    {
        ...
        private readonly DbEntityManager<Discipline> _disciplineManager;
        private readonly DbEntityManager<RaceStatus> _raceStatusManager;
        private readonly DbEntityManager<Track> _trackManager;

        public RacesController(RaceManager raceManager, DbEntityManager<Discipline> disciplineManager, DbEntityManager<RaceStatus> raceStatusManager, DbEntityManager<Track> trackManager)
        {
